        ...
        <div class="content-wrapper">
          <div class="page-header page-header-perspective page-header-perspective-transparent">
            <div class="page-header-left"><a class="brand" href="index.html">
                <div class="brand-logo-default"><img src="images/logo-default-199x36.png" alt="" width="199" height="36"/>
                </div>
                <div class="brand-logo-white"><img src="images/logo-white-200x36.png" alt="" width="200" height="36"/>
                </div></a></div>
          ...
          <div id="wrapper">
            <section class="jumbotron-custom jumbotron-custom-1 bg-gray-base bg-image text-center" style="background-image: url(images/bg-image-2.jpg);">
              <div class="jumbotron-custom-content">
                <div class="shell">
                  <div class="range range-sm-center">
                    <div class="cell-sm-10 cell-lg-9"><a class="brand-big" href="index.html"><img src="images/logo-md-white-136x160.png" alt="" width="136" height="160"/></a>
                    ...
                    <div class="range range-30">
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="images/icon-service-1-70x62.png" alt="" width="70" height="62"/>
                          </figure>
                      ...
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="images/icon-service-2-70x62.png" alt="" width="70" height="62"/>
                          </figure>
                      ...
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="images/icon-service-3-70x62.png" alt="" width="70" height="62"/>
                          </figure>
                      ...
                      <div class="cell-xs-6 cell-md-3">
                        <article class="box-icon">
                          <figure class="box-icon-image"><img src="images/icon-service-4-70x62.png" alt="" width="70" height="62"/>
                          </figure>
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                <article class="box-promo">
                  <div class="box-promo-left"><img class="box-promo-image" src="images/home-1-585x580.jpg" alt="" width="585" height="580"/>
                  </div>
            ...
            <section class="section-xxl bg-gray-dark bg-gray-dark-overlay bg-image" style="background-image: url(images/bg-image-3.jpg);">
              <div class="shell">
                <div class="range">
                  ...
                  <div class="cell-xs-12">
                    ...
                    <div class="owl-carousel owl-carousel-modern owl-spacing-1" data-items="1" data-stage-padding="0" data-loop="true" data-margin="20" data-xs-margin="30" data-mouse-drag="false" data-nav="true" data-dots="true" data-animation-in="fadeIn" data-animation-out="fadeOut">
                      <div class="item">
                                    <blockquote class="quote-fullwidth">
                                      <div class="quote-fullwidth-left">
                                        <div class="quote-fullwidth-avatar"><img src="images/testimonials-1-100x100.jpg" alt="" width="100" height="100"/>
                                        </div>
                                      </div>
                      ...
                      <div class="item">
                                    <blockquote class="quote-fullwidth">
                                      <div class="quote-fullwidth-left">
                                        <div class="quote-fullwidth-avatar"><img src="images/testimonials-2-100x100.jpg" alt="" width="100" height="100"/>
                                        </div>
                                      </div>
                                      <div class="quote-fullwidth-body">
                                        <div class="quote-fullwidth-header">
                      ...
                      <div class="item">
                                    <blockquote class="quote-fullwidth">
                                      <div class="quote-fullwidth-left">
                                        <div class="quote-fullwidth-avatar"><img src="images/testimonials-3-100x100.jpg" alt="" width="100" height="100"/>
                                        </div>
                                      </div>
                                      <div class="quote-fullwidth-body">
                                        <div class="quote-fullwidth-header">
            ...
            <section class="section-xl bg-periglacial-blue text-center">
              <div class="shell">
                ...
                <article class="box-post box-post-dark box-post-reverse box-post-image-right-bottom">
                  <div class="box-post-left"><img class="box-post-image" src="images/box-post-1-530x490.png" alt="" width="530" height="490"/>
                  </div>
                ...
                <article class="box-post">
                  <div class="box-post-left"><img class="box-post-image" src="images/box-post-2-530x490.png" alt="" width="530" height="490"/>
                  </div>
                  <div class="box-post-body">
                ...
                <article class="box-post box-post-dark box-post-reverse">
                  <div class="box-post-left"><img class="box-post-image" src="images/box-post-3-530x490.png" alt="" width="530" height="490"/>
                  </div>
                  <div class="box-post-body">
